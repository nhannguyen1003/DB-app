...
ADD UNIQUE INDEX ssn_idx(ssn),
ADD UNIQUE INDEX email_idx(email),
ADD INDEX name_idx(last_name, first_name);

ALTER TABLE course
ADD INDEX name_course_idx(name),
ADD INDEX fee_course_idx(tuition_fee);

ALTER TABLE course_in_field
ADD INDEX cif_idx(fieldid, courseid);

ALTER TABLE field
ADD INDEX fieldname_idx(name);
